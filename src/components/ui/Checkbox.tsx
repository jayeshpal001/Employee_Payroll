...
export const Checkbox = ({ label, checked, onChange, disabled, message }: CheckboxProps) => (
  <div className="space-y-2">
    ...
    >
      ...
      {disabled && (
        <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(0,0,0,0.02)_25%,rgba(0,0,0,0.02)_50%,transparent_50%,transparent_75%,rgba(0,0,0,0.02)_75%,rgba(0,0,0,0.02)_100%)] bg-size-[10px_10px] pointer-events-none" />
      )}
    </label>
